...
// private final Scanner scanner = new Scanner(System.in); // shared scanner,
// not closed (System.in)
// private final Object consoleLock = new Object(); // synchronize mixed output
...
// success = client.getResponseLegacy().isOk();
// } catch (Exception ex) {
// success = false;
// }
// if (success) {
...
// // Non-blocking: send request; receiver thread will print the list from
// server
// // response
...
// // If this is a message payload JSON, extract fields for rendering
// try {
...
// com.rasel.common.ChatMessagePayload payload = mapper.readValue(text,
// com.rasel.common.ChatMessagePayload.class);
// if (payload != null) {
