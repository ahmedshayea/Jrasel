...
public class TerminalClient {
    ...
    //     try {
    //         if (response.getResource() != null && response.getResource().name().equals("MESSAGES")
    //             && response.getDataType() == com.rasel.common.DataType.JSON) {
    //             com.fasterxml.jackson.databind.ObjectMapper mapper = new com.fasterxml.jackson.databind.ObjectMapper();
    //             com.rasel.common.ChatMessagePayload payload =
    //                 mapper.readValue(text, com.rasel.common.ChatMessagePayload.class);
    //             if (payload != null) {
